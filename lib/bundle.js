...
var Easing = function Easing() {
  ...
  this.createEasing = function (easing) {
    ...
    if (Array.isArray(easing)) {
      return BezierEasing__default["default"].apply(void 0, easing);
    } else {
      // 防止传入无效 stringKey
      var easingVal = this.bulitInEasing[easing];
      easingVal = easingVal ? easingVal : this.bulitInEasing['linear'];
      return BezierEasing__default["default"].apply(void 0, easingVal);
    }
  }.bind(this);
...
var Store = /*#__PURE__*/function () {
  ...
  _proto.handelColorParams = function handelColorParams(valueObj) {
    ...
    return Object.keys(valueObj).reduce(function (prev, key) {
      ...
      prev[key] = colorString__default["default"].get(valueObj[key]).value;
      return prev;
    }.bind(this), {
      startValue: [],
      endValue: []
...
var Switch = /*#__PURE__*/function (_Public) {
  _inheritsLoose__default["default"](Switch, _Public);
  ...
  function Switch(elementConfig) {
    ...
    _this4.start = function () {
      ...
      if (!_this4.targetStyle) {
        Object.values(storeInstance.store).forEach(function (_ref) {
          _newArrowCheck__default["default"](this, _this6);
    ...
    _this4.runSwitchAnimation = function (direction) {
      ...
      requestAnimationFrame(function () {
        ...
        _newArrowCheck__default["default"](this, _this7);

        var _assertThisInitialize = _assertThisInitialized__default["default"](_this4),
        ...
        if (targetStyle) {
          ...
          Object.keys(typeStore).forEach(function (styleName) {
            _newArrowCheck__default["default"](this, _this8);
...
var SwitchAnimation = /*#__PURE__*/function (_Switch) {
  _inheritsLoose__default["default"](SwitchAnimation, _Switch);
  ...
  function SwitchAnimation(elementConfig) {
    ...
    _this9.getInstanceEvent = function () {
      ...
      _newArrowCheck__default["default"](this, _this10);

      return {
        isAnimationShow: function isAnimationShow() {
          _newArrowCheck__default["default"](this, _this11);
...
module.exports = SwitchAnimation;
